    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-5 xl:grid-cols-[1.25fr_0.75fr]">
        <Card>
          ...
          {pages.length === 0 ? <EmptyState icon={FileText} title={t('adminMarketingPlatform.noPlatformPagesYet')} description="Create the first page and the worker will prepare its content automatically." /> : (
