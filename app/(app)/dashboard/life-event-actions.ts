...
// renovation and vacation off to the modules that own them — all of it rolled
// back together if any single write fails. This file stays what it should be:
...
import { launchLifeEvent, type LifeEventHandoff } from '@/lib/life-events/launch';
 ...
 *  template's lead time from today. All or nothing. */
