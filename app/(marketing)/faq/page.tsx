...
export const metadata: Metadata = {
  title: 'FAQ',
  description: 'Common questions about FamilyOS — privacy, roles, the AI assistant, pricing, and mobile apps.',
};
...
const FAQS: FAQ[] = [
  ...
  { q: 'Is there a mobile app?', a: 'FamilyOS is an installable Progressive Web App today, and ships native iOS and Android companion apps built with Expo that share the same data and design.' },
  ...
  { q: 'How do notifications work?', a: 'FamilyOS sends timely push and email reminders for due chores, medications, calendar and school/sports events, home maintenance, and expiring documents — based on each member’s preferences.' },
];
