...
| Unit tests | PASS, 2,781 tests / 351 files | `npm.cmd exec vitest run` |
...
| Auth Admin probe | BLOCKED/FAIL | live GoTrue HTTP 500 `Database error finding users` (`019f60ca-de39-7f6a-aa26-6c69ebc03519`) |
