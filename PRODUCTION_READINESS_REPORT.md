...
The tree compiles, passes lint and type checking, passes 2,821 unit tests, builds all 235 Next.js build
...
- 361 unit-test files and 2,821 passing tests.
...
| Unit tests | PASS, 2,821 tests / 361 files | `npm.cmd exec vitest run` |
