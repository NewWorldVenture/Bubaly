...
tree compiles, passes lint and type checking, passes 2,632 unit tests, builds all 234 Next.js build
...
- 323 unit-test files and 2,632 passing tests.
...
| Unit tests | PASS, 2,632 tests / 323 files | `npm.cmd test` |
