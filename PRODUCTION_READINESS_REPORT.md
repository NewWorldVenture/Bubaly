...
The tree compiles, passes lint and type checking, passes 2,829 unit tests, builds all 235 Next.js build
...
- 364 unit-test files and 2,829 passing tests.
...
| Unit tests | PASS, 2,829 tests / 364 files | `npm.cmd exec vitest run` |
