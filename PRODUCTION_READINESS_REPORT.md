...
tree compiles, passes lint and type checking, passes 2,633 unit tests, builds all 234 Next.js build
...
- 324 unit-test files and 2,633 passing tests.
...
| Unit tests | PASS, 2,633 tests / 324 files | `npm.cmd test` |
