...
tree compiles, passes lint and type checking, passes 2,604 unit tests, builds all 234 Next.js build
...
- 317 unit-test files and 2,604 passing tests.
...
| Unit tests | PASS, 2,604 tests / 317 files | `npm.cmd test` |
