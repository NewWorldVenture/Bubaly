...
tree compiles, passes lint and type checking, passes 2,552 unit tests, builds all 233 Next.js build
...
- 304 unit-test files and 2,552 passing tests.
...
| Unit tests | PASS, 2,552 tests / 304 files | `npm.cmd test` |
