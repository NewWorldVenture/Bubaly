...
tree compiles, passes lint and type checking, passes 2,605 unit tests, builds all 234 Next.js build
...
- 317 unit-test files and 2,605 passing tests.
...
| Unit tests | PASS, 2,605 tests / 317 files | `npm.cmd test` |
