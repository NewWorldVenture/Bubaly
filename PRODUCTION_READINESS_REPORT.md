...
The tree compiles, passes lint and type checking, passes 2,827 unit tests, builds all 235 Next.js build
...
- 363 unit-test files and 2,827 passing tests.
...
| Unit tests | PASS, 2,827 tests / 363 files | `npm.cmd exec vitest run` |
