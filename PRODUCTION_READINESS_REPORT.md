...
The tree compiles, passes lint and type checking, passes 2,867 unit tests, builds all 235 Next.js build
...
- 368 unit-test files and 2,867 passing tests.
...
| Unit tests | PASS, 2,867 tests / 368 files | `npm.cmd exec vitest run` |
