...
tree compiles, passes lint and type checking, passes 2,601 unit tests, builds all 234 Next.js build
...
- 316 unit-test files and 2,601 passing tests.
...
| Unit tests | PASS, 2,601 tests / 316 files | `npm.cmd test` |
