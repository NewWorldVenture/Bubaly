...
The tree compiles, passes lint and type checking, passes 2,885 unit tests, builds all 235 Next.js build
...
- 374 unit-test files and 2,885 passing tests.
...
| Unit tests | PASS, 2,885 tests / 374 files | `npm.cmd exec vitest run` |
