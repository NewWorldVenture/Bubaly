...
The tree compiles, passes lint and type checking, passes 2,876 unit tests, builds all 235 Next.js build
...
- 371 unit-test files and 2,876 passing tests.
...
| Unit tests | PASS, 2,876 tests / 371 files | `npm.cmd exec vitest run` |
