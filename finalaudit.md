...
**Recorded and deliberately not fixed here:** **AQ-01** (needs I18N-001's per-member locale column or a mechanism change), **BD-02 / BE-01 / ARCH-001** (moving the React resolution changes what 1,228 test files run against, so it is its own pass).
