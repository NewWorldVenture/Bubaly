...
export const SERVICE_DESCRIPTIONS: Record<string, string> = {
  ...
  '/dashboard/library': 'Subscribe to podcasts and add audiobooks, then play them with each person’s place kept separately — save the ones worth keeping and download them for offline.',
  ...
  '/dashboard/language': 'Kids and parents learning a language together: spaced-repetition vocabulary, weekly minutes and streaks, an hours-to-level estimate, and an AI tutor that answers in the language with gentle corrections.',
  ...
  '/dashboard/assistants': 'Connect Alexa, Siri, Google Assistant or Home Assistant so a speaker can add events, tasks and shopping items for your family.',
