...
export interface Database {
  public: {
    Tables: {
      ...
      // ---- Admin Tier & Features gating (migration 0054) ----
      feature_settings: T<
        { key: string; tier: string; updated_by: string | null; updated_at: string },
        { key: string; tier: string; updated_by?: string | null; updated_at?: string },
        Partial<{ tier: string; updated_by: string | null; updated_at: string }>
      >;
    };
