  ...
  public: {
    Tables: {
      ...
      social_accounts: T<
        ...
        Partial<{ account_type: string | null; provider_account_id: string | null; handle: string | null; display_name: string | null; avatar_url: string | null; profile_url: string | null; status: SocialAccountStatus; health: string; scopes: string[]; last_synced_at: string | null; last_error: string | null; updated_by: string | null; deleted_at: string | null; metadata: Json }>
      >;
      social_account_tokens: T<
        ...
        Partial<{ provider_account_id: string | null; access_token_enc: string | null; refresh_token_enc: string | null; token_type: string | null; scope: string | null; expires_at: string | null; updated_by: string | null; metadata: Json }>
      >;
      social_feed_items: T<
