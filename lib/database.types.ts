...
export interface Database {
  public: {
    Tables: {
      ...
      >;
      estate_documents: T<
        { id: string; family_id: string; created_by: string | null; document_type: EstateDocumentType; title: string; description: string; holder_name: string; review_status: EstateReviewStatus; effective_date: string | null; expiration_date: string | null; last_reviewed: string | null; next_review: string | null; attorney_name: string; attorney_phone: string; attorney_email: string; document_path: string; notes: string; is_active: boolean } & Stamps,
        { id?: string; family_id: string; created_by?: string | null; document_type?: EstateDocumentType; title: string; description?: string; holder_name?: string; review_status?: EstateReviewStatus; effective_date?: string | null; expiration_date?: string | null; last_reviewed?: string | null; next_review?: string | null; attorney_name?: string; attorney_phone?: string; attorney_email?: string; document_path?: string; notes?: string; is_active?: boolean },
        Partial<{ document_type: EstateDocumentType; title: string; description: string; holder_name: string; review_status: EstateReviewStatus; effective_date: string | null; expiration_date: string | null; last_reviewed: string | null; next_review: string | null; attorney_name: string; attorney_phone: string; attorney_email: string; document_path: string; notes: string; is_active: boolean }>
      >;
      estate_digital_accounts: T<
      ...
      >;
      family_relocations: T<
        { id: string; family_id: string; created_by: string | null; title: string; from_location: string; to_location: string; status: RelocationStatus; target_date: string | null; budget: number | null; reason: string; notes: string; is_active: boolean } & Stamps,
        { id?: string; family_id: string; created_by?: string | null; title: string; from_location?: string; to_location?: string; status?: RelocationStatus; target_date?: string | null; budget?: number | null; reason?: string; notes?: string; is_active?: boolean },
        Partial<{ title: string; from_location: string; to_location: string; status: RelocationStatus; target_date: string | null; budget: number | null; reason: string; notes: string; is_active: boolean }>
      >;
      relocation_tasks: T<
