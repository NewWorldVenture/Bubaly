  ...
  public: {
    Tables: {
      ...
      marketplace_listings: T<
        { id: string; family_id: string; member_id: string | null; title: string; description: string | null; kind: string; category: string; condition: string | null; price_cents: number; rent_period: string | null; photo_url: string | null; location: string | null; status: string; claimed_by: string | null; claimed_at: string | null; created_by: string | null; owner_user_id: string | null; visibility: string; modes: string[]; subcategory: string | null; brand: string | null; color: string | null; size: string | null; deposit_cents: number | null; late_fee_cents: number | null; allow_offers: boolean; is_auction: boolean; currency: string; latitude: number | null; longitude: number | null; view_count: number; tags: string[]; updated_by: string | null; deleted_at: string | null; metadata: Json } & Stamps,
        { id?: string; family_id: string; member_id?: string | null; title: string; description?: string | null; kind?: string; category?: string; condition?: string | null; price_cents?: number; rent_period?: string | null; photo_url?: string | null; location?: string | null; status?: string; claimed_by?: string | null; claimed_at?: string | null; created_by?: string | null; owner_user_id?: string | null; visibility?: string; modes?: string[]; subcategory?: string | null; brand?: string | null; color?: string | null; size?: string | null; deposit_cents?: number | null; late_fee_cents?: number | null; allow_offers?: boolean; is_auction?: boolean; currency?: string; latitude?: number | null; longitude?: number | null; view_count?: number; tags?: string[]; updated_by?: string | null; deleted_at?: string | null; metadata?: Json },
        Partial<{ member_id: string | null; title: string; description: string | null; kind: string; category: string; condition: string | null; price_cents: number; rent_period: string | null; photo_url: string | null; location: string | null; status: string; claimed_by: string | null; claimed_at: string | null; visibility: string; modes: string[]; subcategory: string | null; brand: string | null; color: string | null; size: string | null; deposit_cents: number | null; late_fee_cents: number | null; allow_offers: boolean; is_auction: boolean; currency: string; latitude: number | null; longitude: number | null; view_count: number; tags: string[]; updated_by: string | null; deleted_at: string | null; metadata: Json }>
      >;
      ...
      >;
      marketplace_requests: T<
        { id: string; family_id: string; owner_user_id: string | null; member_id: string | null; title: string; description: string | null; item_type: string | null; preferred_mode: string | null; size: string | null; color: string | null; brand: string | null; condition: string | null; needed_on: string | null; return_by: string | null; location: string | null; radius_miles: number | null; budget_cents: number | null; status: string; created_by: string | null; updated_by: string | null; deleted_at: string | null; metadata: Json } & Stamps,
        { id?: string; family_id: string; owner_user_id?: string | null; member_id?: string | null; title: string; description?: string | null; item_type?: string | null; preferred_mode?: string | null; size?: string | null; color?: string | null; brand?: string | null; condition?: string | null; needed_on?: string | null; return_by?: string | null; location?: string | null; radius_miles?: number | null; budget_cents?: number | null; status?: string; created_by?: string | null; updated_by?: string | null; deleted_at?: string | null; metadata?: Json },
        Partial<{ title: string; description: string | null; item_type: string | null; preferred_mode: string | null; size: string | null; color: string | null; brand: string | null; condition: string | null; needed_on: string | null; return_by: string | null; location: string | null; radius_miles: number | null; budget_cents: number | null; status: string; updated_by: string | null; deleted_at: string | null; metadata: Json }>
      >;
      marketplace_request_matches: T<
        { id: string; family_id: string; request_id: string; listing_id: string | null; score: number | null; reason: string | null; status: string; metadata: Json } & Stamps,
        { id?: string; family_id: string; request_id: string; listing_id?: string | null; score?: number | null; reason?: string | null; status?: string; metadata?: Json },
        Partial<{ listing_id: string | null; score: number | null; reason: string | null; status: string; metadata: Json }>
      >;
