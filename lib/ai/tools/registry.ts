...
for (const tool of [...calendarTools, ...taskTools, ...groceryTools, ...mealTools, ...reminderTools, ...familyTools, ...notificationTools, ...memoryTools, ...messageTools, ...financeTools, ...tripTools, ...travelImportTools, ...homeTools, ...providerTools, ...documentTools, ...schoolTools, ...sportsTools, ...routineTools, ...noteTools]) {
  register(tool);
}
