...
export const INTENT_TOOL_DOMAINS: Record<IntentKey, TrustDomain[]> = {
  ...
  purchase_advice: ['finances', 'shopping', 'home_maintenance', 'tasks', 'messaging'],
  ...
  tournament_day: ['calendar', 'education', 'tasks', 'chores', 'scheduling', 'meal_planning', 'shopping', 'messaging'],
  school_morning: ['calendar', 'education', 'tasks', 'chores', 'scheduling', 'meal_planning', 'messaging'],
  back_to_school: ['calendar', 'education', 'tasks', 'chores', 'scheduling', 'shopping', 'documents', 'messaging'],
  holiday: ['calendar', 'tasks', 'chores', 'scheduling', 'meal_planning', 'shopping', 'finances', 'travel', 'messaging'],
  emergency_prep: ['home_maintenance', 'documents', 'tasks', 'chores', 'calendar', 'scheduling', 'shopping', 'messaging'],
  life_event: ['calendar', 'education', 'tasks', 'chores', 'scheduling', 'shopping', 'home_maintenance', 'travel', 'documents', 'messaging'],
