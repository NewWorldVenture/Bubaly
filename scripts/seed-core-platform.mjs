...
const EXTRA_TASKS = [
  ...
  ['Get new library cards','low',null,false,0],['Set up FamilyOS for all members','high',0,true,0],
  ...
  ['Update FamilyOS emergency contacts','high',1,false,0],['Scan and digitize old family photos','low',null,false,9],
