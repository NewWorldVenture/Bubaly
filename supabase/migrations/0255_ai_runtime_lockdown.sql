-- ============================================================================
-- 0255_ai_runtime_lockdown.sql - runtime INSERT lockdown, conversation
-- ownership and retried-request deduplication; preserve 0252 authority guards.
-- Broader raw-runtime requester privacy is not closed by this migration.
-- ----------------------------------------------------------------------------
