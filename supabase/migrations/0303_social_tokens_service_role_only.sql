-- ============================================================
-- Migration 0303: put the OAuth token store back behind the service role
--
...
begin
  ...
  if n <> 0 then
    raise exception '0303: social_account_tokens still carries % policy(ies) — the token store is reachable from PostgREST', n;
  end if;
end $$;
