...
select f.id,
       ...
       (array['appointment','school','sports','general'])[s+1]::public.event_category,
...
select f.id,
       ...
       (array['birthday','sports','general','holiday','school','appointment','general','sports','general','general','school','general'])[1+(n%12)]::public.event_category,
