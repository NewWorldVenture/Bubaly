...
NEXT: S-05 (163 CASCADE FKs with no index — measured 5,715 buffers -> 4), Claude-4's #4 (/dashboard/home sold as Plus, opened at Basic) and #5 (/dashboard/experience in every sidebar with nothing writing experience_audits), then U-05 (74 icon-only buttons with no accessible name). Rebuild finalaudit.md from all four files as each lands.
