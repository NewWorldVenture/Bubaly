...
NEXT: the four semantic text colours that fail WCAG AA in light mode across 504 sites, then CONVERT the 249 remaining hardcoded-locale formatter sites (the ratchet's ceiling). Rebuild finalaudit.md from all four files as each lands.
