...
describe('Supabase migration filename safety', () => {
  ...
  it('points new migrations at the next unused version', () => {
    ...
    //
    // This reads 0336: main holds 0001-0317, this branch 0318-0327, 0328-0332,
    // 0333 (Guardian screening is a parent's to configure), 0334 (a social
    // restriction is not its holder's to lift) and 0335 (a reward is paid for
    // with points that exist). 0333 touches only guardian_contacts and
