...
describe('Supabase migration filename safety', () => {
  ...
  it('points new migrations at the next unused version', () => {
    // Bumped whenever a migration lands — 0322 stops a social admin from
    // managing social access. Stating it rather than deriving it is
    ...
    expect(audit.nextVersion).toBe('0323');
  });
