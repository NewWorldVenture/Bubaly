...
-- The workflow applies actual 0274 after this file. Main E2E owns full-chain coverage.
DO $$
BEGIN
  IF current_database() <> 'bubaly_finance_operation_ci'
    ...
    RAISE EXCEPTION '0274 bootstrap requires its dedicated synthetic PostgreSQL 17 database';
  END IF;
END $$;
