...
describe('Outcomes reasoning read boundary', () => {
  it('surfaces shared context failures while preserving the outcome planner', () => {
    ...
    expectSays(page, 'outcomes.relationshipInsightsAreTemporarilyUnavailable', 'Relationship insights are temporarily unavailable from Supabase. Refresh and try again.');
