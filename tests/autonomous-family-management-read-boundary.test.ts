...
describe('autonomous family management read boundary', () => {
  it('preserves required signal and automation read failures before rendering controls', () => {
    ...
    expectSays(page, 'autonomousFamilyManagement.couldNotLoadAutonomousFamily', 'Could not load autonomous family management data from Supabase. Refresh and try again.');
