...
describe('the social OAuth token store is reachable only by the service role', () => {
  it('no migration after 0318 creates a policy on it', () => {
    ...
    expect(offenders, 'this table is service-role only — see migration 0034 and 0318').toEqual([]);
  });
