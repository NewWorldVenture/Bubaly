        ...
        <div className="module-page">
                  ...
                  <div key={v.id} className="flex items-start gap-3 px-4 py-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <span className="shrink-0 text-[10px] text-muted">{fmtTime(v.occurred_at, locale)}</span>
                      </div>
          ...
          <div className="mt-4 space-y-3">
            <div className="relative">
              ...
              {search && (
                <button aria-label={tr('iconAction.clearSearch')} onClick={() => setSearch('')} className="absolute right-3 top-1/2 -translate-y-1/2 text-muted hover:text-fg">
                  <X className="h-4 w-4" />
                </button>
              )}
            </div>
                    ...
                    <button key={call.id} onClick={() => openDetail(call)}
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <span className="shrink-0 text-[10px] text-muted">{fmtTime(call.received_at, locale)}</span>
                        </div>
    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-3 border-b border-border px-4 py-3 flex-shrink-0">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="text-[10px] text-muted">{st.label} · {fmtTime(call.received_at, locale)}</div>
        </div>
      </div>
