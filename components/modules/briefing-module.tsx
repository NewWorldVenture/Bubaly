            ...
            return (
              <li key={i}>
                <a href={meta.href}
                  ...
                  <ChevronRight className="h-4 w-4 text-muted opacity-100 sm:opacity-0 sm:group-hover:opacity-100 focus-visible:opacity-100 transition-opacity flex-shrink-0" />
                </a>
              </li>
            );
          })}
