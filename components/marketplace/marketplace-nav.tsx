...
import {
  ...
  Receipt, Star, Heart, ShieldCheck, Plus, BellRing, Activity, MessageSquare, UserCheck, HeartHandshake, Gavel, Handshake, LayoutDashboard, Tag,
} from 'lucide-react';
...
const ITEMS: Item[] = [
  ...
  { href: `${BASE}/negotiations`, label: 'Offers', icon: Handshake },
        ...
        return (
          <Link
            ...
            className={cn(
              ...
              active ? 'bg-brand/10 font-medium text-brand-text' : 'text-muted hover:bg-elevated hover:text-fg',
            )}
          >
