    ...
    return (
      <div className="flex h-full flex-col">
        ...
        >
          ...
          <button aria-label={tr('iconAction.close')} type="button" onClick={() => setPicking(false)} className="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-white/10 text-white/70 hover:bg-white/20"><X className="h-4 w-4" /></button>
        </form>
      </div>
    );
  }
