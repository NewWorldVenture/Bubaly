    ...
    <div className="relative z-10 flex h-full flex-col justify-center p-4 sm:p-6 lg:w-[50%] lg:p-7">
      <div className="assistant-message-enter space-y-3">
        ...
        <div className="flex items-end gap-2.5">
          ...
          <div className="rounded-2xl rounded-bl-md border border-violet-300/15 bg-[#172231]/90 px-4 py-3 text-xs leading-5 text-white/86 shadow-xl backdrop-blur-xl sm:text-sm sm:leading-6">
