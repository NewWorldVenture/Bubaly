      ...
      <div className="assistant-message-enter space-y-3">
        ...
        <div className="flex items-end gap-2.5">
          ...
          <div className="rounded-2xl rounded-bl-md border border-violet-300/15 bg-[#172231]/92 px-4 py-3 text-xs leading-5 text-white/86 shadow-xl backdrop-blur-xl sm:text-sm sm:leading-6">
            You have 6 events this week. Soccer practice on Tue &amp; Thu, a math test Friday, and family dinner Sunday.
          </div>
        </div>
        <div className="ml-auto mt-2 w-fit max-w-[90%] rounded-2xl rounded-br-md border border-white/10 bg-white/[0.10] px-4 py-3 text-xs font-medium leading-5 text-white shadow-xl backdrop-blur-xl sm:text-sm">
          Plan dinners for the week
        </div>
        <div className="flex items-end gap-2.5">
          <span className="glow-dot mb-1 h-7 w-7 shrink-0" />
          <div className="rounded-2xl rounded-bl-md border border-violet-300/15 bg-[#172231]/92 px-4 py-3 text-xs leading-5 text-white/86 shadow-xl backdrop-blur-xl sm:text-sm sm:leading-6">
            Here&apos;s your meal plan: Honey Garlic Chicken, Taco Bowls, Salmon &amp; Veggies, Pasta Primavera, and Homemade Pizza.
          </div>
        </div>
      </div>
    </div>
