...
function whenLabel(iso: string, yesterday: string, locale: LocaleCode): string {
            ...
            return (
              <li key={item.key}>
                ...
                >
                  ...
                  <span className="shrink-0 text-xs text-muted">{whenLabel(item.at, t('completedByBubaly.yesterday'), locale.code)}</span>
