...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 463 Vitest files, 3,210 tests; 250-route production build; lint/typecheck/audit | Keep green after every repair |
