...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 422 Vitest files, 3,086 tests; clean 250-route build; lint/typecheck/audit | Keep green after every repair |
| A-02 | Supabase migration, schema probe and independent seed baseline | 5 | Verified | 228 migration audit; 11 live schema probes; 600-record seed invariant | Verify remote migration ledger and seed execution |
...
| A-17 | Admin, marketing, social and content management | 4 | In progress | Admin route inventory, notification helpers, document deletion, family creation, allowlist-read, content-read, report-read, and audit-read failure boundary tests | Verify Super Admin permissions, CRUD, media, storage/family rollback, real-time saves, alert routing, and audit log |
