...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 416 Vitest files, 3,077 tests; clean 250-route build; lint/typecheck/audit | Keep green after every repair |
