...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 418 Vitest files, 3,081 tests; clean 250-route build; lint/typecheck/audit | Keep green after every repair |
...
| A-17 | Admin, marketing, social and content management | 4 | In progress | Admin route inventory, notification helpers, document deletion, and family creation failure boundary tests | Verify Super Admin permissions, CRUD, media, storage/family rollback, real-time saves, alert routing, and audit log |
