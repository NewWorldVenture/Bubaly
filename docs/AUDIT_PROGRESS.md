...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 450 Vitest files, 3,178 tests; 250-route production build; lint/typecheck/audit | Keep green after every repair |
...
| A-16 | Notifications, reminders, automations and cron jobs | 4 | In progress | Cron auth, allowance recovery/plan-gating, and Admin digest failure-summary tests | Verify schedules, retries, deduplication, delivery and observability |
