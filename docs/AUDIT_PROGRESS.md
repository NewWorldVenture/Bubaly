...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 407 Vitest files, 3,035 tests; clean 250-route build; lint/typecheck/audit | Keep green after every repair |
