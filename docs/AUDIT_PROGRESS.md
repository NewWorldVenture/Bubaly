...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 455 Vitest files, 3,195 tests; 250-route production build; lint/typecheck/audit | Keep green after every repair |
...
| A-08 | Wallet, goals, allowances, transfers and treasury | 7 | In progress | Atomic wallet RPCs, goal funding repair, allowance recovery tests, remaining-wallet read-boundary coverage, family-scoped wallet hub deletion, and checked wallet provisioning/approval failure paths | Verify every wallet page, RPC deployment, concurrency and reconciliation |
