...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 420 Vitest files, 3,083 tests; clean 250-route build; lint/typecheck/audit | Keep green after every repair |
...
| A-17 | Admin, marketing, social and content management | 4 | In progress | Admin route inventory, notification helpers, document deletion, family creation, allowlist-read, and content-read failure boundary tests | Verify Super Admin permissions, CRUD, media, storage/family rollback, real-time saves, alert routing, and audit log |
