...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 450 Vitest files, 3,177 tests; 250-route production build; lint/typecheck/audit | Keep green after every repair |
