...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 471 Vitest files, 3,226 tests; 250-route production build; lint/typecheck/audit | Keep green after every repair |
