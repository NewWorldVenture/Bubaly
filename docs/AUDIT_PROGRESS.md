...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 415 Vitest files, 3,073 tests; clean 250-route build; lint/typecheck/audit | Keep green after every repair |
