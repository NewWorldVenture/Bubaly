...
| A-10 | Meals, groceries, nutrition and food household data | 4 | In progress | Meal-planning persistence repair + retryable Recipes/Shopping reads + Food & Nutrition hub degrade-and-log read boundary (PLA-0418, `agent-02`) | Verify sibling client-view reads, all CRUD, AI, imports, empty states, live RLS, relational seed |
