...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 455 Vitest files, 3,190 tests; 250-route production build; lint/typecheck/audit | Keep green after every repair |
