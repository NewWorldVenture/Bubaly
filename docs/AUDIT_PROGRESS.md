...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 451 Vitest files, 3,180 tests; 250-route production build; lint/typecheck/audit | Keep green after every repair |
...
| A-08 | Wallet, goals, allowances, transfers and treasury | 7 | In progress | Atomic wallet RPCs, goal funding repair, allowance recovery tests, and full remaining-wallet read-boundary coverage | Verify every wallet page, RPC deployment, concurrency and reconciliation |
...
| A-16 | Notifications, reminders, automations and cron jobs | 4 | In progress | Cron auth, allowance recovery/plan-gating, digest read/delivery boundaries, and Admin digest failure-summary tests | Verify schedules, retries, deduplication, delivery and observability |
