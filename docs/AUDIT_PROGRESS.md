...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 469 Vitest files, 3,222 tests; 250-route production build; lint/typecheck/audit | Keep green after every repair |
...
| A-13 | Vacations, travel, itineraries and concierge | 4 | In progress | Vacation AI persistence repair plus retryable Vacation Reports, Trip Overview, Trip Itinerary, shared CRUD, Budget, Emergency Summary, Weather, and Packing read boundaries | Verify every trip workflow, external integration, media and recovery path |
