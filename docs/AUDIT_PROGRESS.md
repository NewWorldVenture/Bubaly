...
| --- | --- | ---: | --- | --- | --- |
| A-01 | Build, lint, typecheck, dependency and CI gates | 5 | Verified | 439 Vitest files, 3,137 tests; 250-route production build; lint/typecheck/audit | Keep green after every repair |
