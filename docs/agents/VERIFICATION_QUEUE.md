...
| Closed-loop marketing control-plane audit | `CODEX-01` | c0e37f7f | local gates and integrated main readback complete; live provider/RLS/browser evidence remains external and is tracked in launch blockers |
| (none from QA-01) | — | — | — |
