...
| C-MKT-ADMIN-001 | `MARKETING-ADMIN-01` | Super Admin marketing control plane: content, landing pages, SEO, AEO | `app/(app)/admin/marketing/{content,landing-pages,seo,aeo}/**` + paired actions/tests | 2026-07-18 12:30 | DONE (`c0e37f7f`) |
