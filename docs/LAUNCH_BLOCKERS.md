...
| --- | --- | --- | --- | --- | --- | --- |
| LB-001 | P0 | Supabase Auth Admin users health check returns HTTP 500 | `npm.cmd run db:audit:auth` at 2026-07-16 08:26 America/New_York: public Auth health passed; Admin users returned HTTP 500 `Database error finding users` (request `019f6ae2-b616-7860-9608-8f23138c5e72`) | Supabase project/operator access | Admin users endpoint returns healthy response and auth smoke passes | Open |
