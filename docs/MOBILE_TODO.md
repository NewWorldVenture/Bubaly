...
| M-021 | 6 | Marketing **site-header** control cluster (ThemeToggle 32px, menu button 40px, Log in / Get Started pills 32px) grows to ≥44px on touch (`coarse:min-h-11`/`-w-11`). Public marketing surface (parallel bot) | (this commit) |
