...
| Marketplace | `/marketplace/*`, including `/marketplace/auctions`, seller flows | buyer, seller, admin | RLS, concurrency, payments, media, E2E | In progress | Live Auctions read boundary passes; complete buyer/seller listing to handoff, dispute, media, payment, and responsive/browser evidence |
