...
| Home and dashboards | `/home`, `/dashboard/*`, including `/dashboard/family-signals` and `/dashboard/agents` | parent, child, admin | component, E2E, responsive, accessibility | In progress | Family Intelligence and Family Assistant read boundaries pass; continue action-by-action dashboard traversal |
