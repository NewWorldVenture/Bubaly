...
| Home and dashboards | `/home`, `/dashboard/*`, including `/dashboard/family-signals`, `/dashboard/agents`, and `/dashboard/autonomous-family-management` | parent, child, admin | component, E2E, responsive, accessibility | In progress | Family Intelligence, Family Assistant, and Autonomous Family Management read boundaries pass; continue action-by-action dashboard traversal |
