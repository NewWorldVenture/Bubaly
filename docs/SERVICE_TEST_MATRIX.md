...
| Admin and marketing | `/admin/*`, including `/admin/onboarding`, `/admin/marketing/intelligence`, `/admin/marketing/visitor-intelligence`, and `/admin/marketing/lead-scores` | Super Admin, admin, support | authorization, CRUD, audit, responsive, E2E | In progress | Admin notification, document-deletion, family-creation, allowlist-read, content-read, report-read, audit-read, operational-read, billing-read, notification-read, feedback-read, integration-read, subscription-read, Stripe-read, marketing-read, marketing-dashboard, Onboarding Audit, Customer Intelligence, Visitor Intelligence, Lead Scores, content/campaign, asset/messaging, CRM, control-plane, publishing, rewards/survey failure boundaries pass; complete permission, storage/family rollback, live-save, responsive, and browser matrix |
