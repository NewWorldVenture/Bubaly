...
| Third-party integrations | Connections hub, Google/Microsoft/Apple sync, Stripe, Resend, push, OAuth | connected account owner, system | callback, secret, retry, outage, audit | In progress | 23 connection boundary tests; implemented providers route through real OAuth setup; remaining provider and sandbox callback evidence |
