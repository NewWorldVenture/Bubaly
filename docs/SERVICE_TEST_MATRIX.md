...
| Admin and marketing | `/admin/*`, marketing routes | Super Admin, admin, support | authorization, CRUD, audit, responsive, E2E | In progress | Admin notification, document-deletion, family-creation, allowlist-read, content-read, report-read, audit-read, and operational-read failure boundaries pass; complete permission, storage/family rollback, live-save, responsive, and browser matrix |
