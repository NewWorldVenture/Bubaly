...
| Home and dashboards | `/home`, `/dashboard/*`, including `/dashboard/family-signals` | parent, child, admin | component, E2E, responsive, accessibility | In progress | Family Intelligence read boundary passes; continue action-by-action dashboard traversal |
