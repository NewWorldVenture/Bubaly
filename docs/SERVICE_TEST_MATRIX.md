...
| Admin and marketing | `/admin/*`, marketing routes | Super Admin, admin, support | authorization, CRUD, audit, responsive, E2E | In progress | Admin notification and document-deletion failure boundaries pass; complete permission, storage failure/retry, live-save, responsive, and browser matrix |
