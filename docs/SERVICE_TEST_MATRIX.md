...
| Home and dashboards | `/home`, `/dashboard/*`, including `/dashboard/family-signals`, `/dashboard/agents`, `/dashboard/autonomous-family-management`, and `/dashboard/contacts/[id]` | parent, child, admin | component, E2E, responsive, accessibility | In progress | Family Intelligence, Family Assistant, Autonomous Family Management, and Contact Timeline read boundaries pass; continue action-by-action dashboard traversal |
