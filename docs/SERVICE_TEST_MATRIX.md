...
| Marketplace | `/marketplace/*`, including `/marketplace/auctions`, `/marketplace/selling`, seller flows | buyer, seller, admin | RLS, concurrency, payments, media, E2E | In progress | Live Auctions and Selling read boundaries pass; complete buyer/seller listing to handoff, dispute, media, payment, and responsive/browser evidence |
