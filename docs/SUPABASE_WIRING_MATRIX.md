...
| Admin/marketing | admin audit, content, campaigns, feedback, `admin_notifications`, private documents storage | Super Admin/support roles | admin APIs, media, storage deletion, webhooks, service-role notification feed | Partial | Notification and document-delete failures are locally surfaced; live permission, storage retry, audit-log, alert-routing, and full admin workflow proof pending |
