...
| Notifications | notifications, devices, preferences, `admin_notifications` | family/user ownership plus Super Admin operations | push, email, realtime, cron digest, provider sync | Partial | Admin digest and provider-sync cron now surface local feed/account failures; job-by-job live delivery/replay audit pending |
