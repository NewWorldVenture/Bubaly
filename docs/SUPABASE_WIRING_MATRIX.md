...
| Notifications | notifications, devices, preferences, `admin_notifications` | family/user ownership plus Super Admin operations | push, email, realtime, cron digest | Partial | Admin digest now surfaces feed and recipient failures locally; job-by-job live delivery/replay audit pending |
