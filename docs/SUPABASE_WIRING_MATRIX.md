...
| Notifications | notifications, devices, preferences, `admin_notifications` | family/user ownership plus Super Admin operations | push, email, realtime, cron digest, provider sync, batch crons | Partial | Admin digest, provider-sync, batch, and notification-delivery routes now surface local failures; email helper, live delivery, and replay audit pending |
