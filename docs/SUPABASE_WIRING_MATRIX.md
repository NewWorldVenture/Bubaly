...
| Admin/marketing | admin audit, content, campaigns, feedback, `admin_notifications`, private documents storage, family provisioning, `super_admins` | Super Admin/support roles | admin APIs, media, storage deletion, family membership/subscription reconciliation, allowlist/content/report/audit/operational reads, webhooks, service-role notification feed | Partial | Notification, document-delete, family-create, allowlist-read, content-read, report-read, audit-read, and operational-read failures are locally surfaced; live permission, storage/family rollback, audit-log, alert-routing, and full admin workflow proof pending |
