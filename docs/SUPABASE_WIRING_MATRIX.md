...
| Admin/marketing | admin audit, onboarding, content, campaigns, feedback, `admin_notifications`, private documents storage, family provisioning, `super_admins`, marketing content/assets/customers/CRM/publishing/rewards/surveys, Customer Intelligence telemetry, Visitor Intelligence analytics tables, Lead Scores tables | Super Admin/support roles | admin APIs, media, storage deletion, family membership/subscription reconciliation, allowlist/content/report/audit/operational/billing/notification/feedback/integration/subscription/Stripe/marketing/customer-metric reads, signed previews, webhooks, service-role notification feed | Partial | Notification, document-delete, family-create, allowlist-read, content-read, report-read, audit-read, operational-read, billing-read, notification-read, feedback-read, integration-read, subscription-read, Stripe-read, marketing-read, marketing-dashboard, Onboarding Audit, Customer Intelligence, Visitor Intelligence, Lead Scores, content/campaign, asset/messaging, CRM, control-plane, publishing, rewards/survey failures are locally surfaced; live permission, storage/family rollback, audit-log, alert-routing, and full admin workflow proof pending |
