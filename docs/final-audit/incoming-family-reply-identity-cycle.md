...
The integrated publication `fae35e90` now passes hosted CI `34717274616`: all 14,636 unit tests, 1,062 browser tests, the 252-page build, types/lint/query, database, mobile and finance checks pass. Vercel succeeds. This establishes combined regression/build acceptance; it does not replace the outstanding live family email/provider workflow. Exact checkout/tree evidence is in `guardian-hosted-acceptance.md`.
