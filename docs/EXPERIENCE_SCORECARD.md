...
| **Add a memory** (photo→saved) | 3–5 | 1 | 0–1 | ~20s | ✅ | ✅ per-file upload progress bar ("N of M uploaded") | ⚠️ | In-app camera OR upload; multi-shot. Save button + bar now show live per-photo progress (2026-07-03). |
