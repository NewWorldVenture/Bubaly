...
Last board update: **2026-07-16 23:12 UTC** · by `agent-04`
...
| A-12 | `agent-01` | IN_REVIEW | 2026-07-16 21:38 | 2026-07-16 23:10 | `PLA-0470,0520` | FOUND+FIXED 2 HIGH child-safety bugs: guardian rules (PLA-0470, 11 actions) + family geofences/locator (PLA-0520, savePlace/deletePlace/setGeofenceEnabled) — child could disable safety alerts. isManager gates + guard tests. Open: manager-scoped RLS on guardian_routing_rules + family_places, callbacks/escalation |
