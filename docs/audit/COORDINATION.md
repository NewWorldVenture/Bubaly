...
Last board update: **2026-07-17 00:35 UTC** · by `agent-03`
...
| A-08 | `agent-01` | IN_REVIEW | 2026-07-16 21:16 | 2026-07-17 11:45 | `PLA-0440,0580` | Overspend/idempotency proven (PLA-0440). **FOUND+FIXED CRITICAL**: child could MINT money via direct wallet_transactions INSERT (RLS was is_family_member FOR ALL) — proven live. Migration 0217 restricts wallet ledger WRITES to can_manage_family (reads open); chore auto-approve reward routed via service-role. 8 guard tests total. ⚠️ prod exploitable until 0217 applied (LB-010 P0). Open: allowance/goal/transfer flows |
