...
- Commit: `916ee059` replaces the App Store's “Coming soon” install label with an explicit “Unavailable” state after `2c474f5a` removed disconnected Google Drive and Dropbox document-import actions; live provider and deployment evidence remains open
...
#### TODO-0370 - App Store advertised unavailable catalog entries as “Coming soon”
...
- Required remediation: pass a capability-neutral availability prop and render “Unavailable” for entries that cannot be installed; keep install actions enabled only for available entries.
- Implementation notes: renamed the control prop to `available`, changed the non-installable state to “Unavailable,” and preserved the existing status filter and install/uninstall actions.
