...
- [ ] Run `npm run db:audit:migrations`, then apply migrations in order through `0197_guardian_suggestion_review_transaction.sql`.
...
- [ ] Exercise Guardian suggestion approval/dismissal after applying `0197`; confirm only managers can
...
- [ ] If `0178` through `0197` causes unexpected behavior, stop feature exposure and use the tested migration rollback
